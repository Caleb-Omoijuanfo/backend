...
router.post('/', function(req, res){
  post.create({title:req.body.title, headline: req.body.headline, content:req.body.content, author:req.body.author, category:req.body.category, image:req.body.image}, function(err, Response){
